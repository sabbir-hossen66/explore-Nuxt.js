import { hasInjectionContext, inject, version, defineAsyncComponent, defineComponent, h, computed, unref, ref, provide, shallowReactive, watch, Suspense, Fragment, getCurrentInstance, nextTick, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, withCtx, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, i as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, c as createError$1, s as sanitizeStatusCode, m as getContext, n as createHooks, t as toRouteMatcher, o as createRouter$1, p as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-vttJZDvE.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-COlRVmAr.mjs')
  },
  {
    name: "product-id",
    path: "/product/:id()",
    meta: __nuxt_page_meta$1,
    component: () => import('./_id_-Bg1Mdaco.mjs')
  },
  {
    name: "product",
    path: "/product",
    meta: __nuxt_page_meta,
    component: () => import('./index-DjH4Rap2.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CoBTjOsN.mjs').then((m) => m.default || m)),
  product: defineAsyncComponent(() => import('./product-aSw4AIin.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-7 max-w-sm mx-auto text-center card" }, _attrs))}><p class="mt-7 text-7xl font-bold">${ssrInterpolate(__props.error.statusCode)}</p><p class="mt-7 text-6xl">oops.</p><p class="mt-7">${ssrInterpolate(__props.error.message)}</p><button class="btn my-7"> Go Homeee.</button></div>`);
    };
  }
};
...
export { _export_sfc as _, useNuxtApp as a, asyncDataDefaults as b, createError as c, useRouter as d, entry$1 as default, navigateTo as e, fetchDefaults as f, useRuntimeConfig as g, nuxtLinkDefaults as n, resolveRouteObject as r, useRoute as u };
