...
const _lazy_WgOfqK = () => import('../routes/api/ninja.mjs');
const _lazy_ksMrOn = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/ninja', handler: _lazy_WgOfqK, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_ksMrOn, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ksMrOn, lazy: true, middleware: false, method: undefined }
];
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/sabbir/Desktop/explore/Nuxt/test-project/.data/kv"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "c8d90e0d-ab10-4e81-9f61-7a4db0b6be1b",
